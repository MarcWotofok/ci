			...
			<h1>Modificar Libro</h1>
				<div id='caja'>
					<form action='index.php' method='get'>
						...
						<div class='group'>      
					      <input type='text' name='fecha_edicion' value='".$libros[0]['fecha_edicion']."' required>
					      <span class='highlight'></span>
					      <span class='bar'></span>
					...
					<input type=\"hidden\" name=\"accion\" value=\"modifiedLibro\" href='".site_url("biblioteca/modifiedLibro/".$libros[0]['id_libro'])."'>
